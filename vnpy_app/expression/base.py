...
class Expression(abc.ABC):
    ...
    - time:  it  could be observation time or period time.
        ...
        - period time is designed for Point-in-time database.
        For example, the period time maybe 2014Q4, its value can be observed for multiple times
        (different value may be observed at different time due to amendment).
    """
